...
$query="select * from product_details order by priority DESC";
...
<html lang="en">
   ...
   function category_priority_update(id)
   {
	   ...
	   jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=product_priority_update",
								datatype:"text",
               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Product Details</span></h4>
                     </div>
                    <div class="heading-elements">
						<ul class="icons-list">
                           <li><a href="add_vendor_product.php"><i class="fa fa-plus-square"></i></a></li>
                        </ul>
                     ...
                     <div class="panel-body">
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                          ...
                          <?php
								...
								$sql="select * from product_details order by priority desc limit $pageLimit,".PAGE_PER_NO;
								...
								while($row=mysql_fetch_array($result))
								{
									...
									echo '
											...
											<td><a href="#" id="'.$id.'" onclick="delete_product(this.id)"><i class="fa fa-trash" style="color:blue;"></i></a></td>							
