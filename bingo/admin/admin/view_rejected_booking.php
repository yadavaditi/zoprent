...
function changePagination(pageId,liId){
     ...
     $.ajax({
           type: "POST",
           url: "view_rejected_booking_page.php",
           data: dataString,
           cache: false,
...
$query="select * from booking_details where status='rejected' order by booked_date DESC";
...
<html lang="en">
   ...
   function filter_booking()
   {
	   ...
	   jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=filter_rejected_booking",
								datatype:"text",
								data:{data:data},
      ...
      <div class="page-header">
         <div class="page-header-content">
            <div class="page-title">
               <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Rejected Orders</span> </h4>
            </div>
            <?php 
		 ...
		 <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
		  ...
		  <table class="table">
							  ...
							  <?php
								...
								$sql="select * from booking_details where status='rejected' order by booked_date ASC limit $pageLimit,".PAGE_PER_NO;
