<?php
   if(!isset($_SESSION)){ session_start();} 
	...
	$sql=mysql_query("select * from vendor where id='$id'");
	$row=mysql_fetch_array($sql);
	$vendor_name=$row['vendor_name'];
	$vendor_number=$row['vendor_number'];
	$v_city=$row['vendor_city'];
	$v_location=$row['vendor_location'];
    ...
    if (isset($_POST['submit_now'])) 
    {
			...
			$vendor_loc=$_POST['vendor_loc'];
				...
				$q=mysql_query("update vendor set 
				vendor_name='$vendor_name',vendor_number=$vendor_number,vendor_city='$vendor_city',vendor_location='$vendor_loc' where id='$id'");
               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit</span>- Vendor Details</h4>
                     </div>
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                           <fieldset class="content-group">
							  ...
							  <div class="form-group">
                                 ...
                                 <div class="col-lg-6">
                                    <input type="text" class="form-control" name="vendor_loc" id="vendor_loc" value="<?php echo $v_location; ?>" required>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="control-label col-lg-2">Vendor Name*</label>
                                 <div class="col-lg-6">
                                    <input type="text" class="form-control" name="vendor_name" id="vendor_name" value="<?php echo $vendor_name ?>" required>
                                 </div>
                              </div>
							<div class="form-group">
                                 <label class="control-label col-lg-2">Vendor Number*</label>
                                 <div class="col-lg-6">
                                    <input type="text" class="form-control" name="vendor_number" id="vendor_number" maxlength="10" value="<?php echo $vendor_number ?>" required>
                                 </div>
                              </div>
