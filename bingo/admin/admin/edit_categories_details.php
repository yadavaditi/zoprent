   ...
   if(!isset($_SESSION)){ session_start();} 
    ...
    if (isset($_POST['submit_now'])) 
    {
			...
			$priority=$_POST['priority'];
				...
				$q=mysql_query("update categories set 
				categories='$categories',image='$img',priority='$priority' where id='$id'");
               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit</span>- Category Details</h4>
                     </div>
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                           <fieldset class="content-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-6">
                                    <input type="text" class="form-control" name="category" id="category" value="<?php echo $categories ?>" required>
                                 </div>
                              </div>
							  <div class="form-group">
