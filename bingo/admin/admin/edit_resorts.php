<?php
   if(!isset($_SESSION)){ session_start();} 
	...
	$qry=mysql_query("select * from resorts where id='$id'");
	$res=mysql_fetch_array($qry);
			$city_id=$res['city_id'];
			$resort_name=$res['resort_name'];
			$perday_cost=$res['price_day'];
    ...
    if (isset($_POST['submit_now'])) 
    {
			...
			$perday_cost1=$_POST['oneday_price'];
			$priority1=$_POST['priority'];
			
			
			$q=mysql_query("update resorts set city_id='$city', resort_name='$resort_name1', price_day='$perday_cost1',
							ref_id='$ref_id',priority='$priority1' where id='$id'");
		...
		function delete_image(id)
		{
			...
			r=confirm("Are you Sure Want to Delete ?");
         	if(r==true)
         	{
				jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=delete_image_resort",
								datatype:"text",
								data:{img_id:img_id,ref_id:ref_id},
               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit Resorts</span></h4>
                     </div>
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                           <fieldset class="content-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-6">
                                    <input type="text" class="form-control" name="resort_name" id="resort_name" value="<?php echo $resort_name;?>" required>
                                 </div>
                              </div>
							  ...
							  <div class="form-group">
                                 ...
                                 <div class="col-lg-6">
                                    <input type="text" class="form-control" name="oneday_price" id="oneday_price" value="<?php echo $perday_cost;?>" required>
                                 </div>
                              </div>
							  <div class="form-group">
				  ...
				  <div class="panel panel-flat">
                     <table class="table">
                        ...
                        <tbody id="get_table">
                           <?php
							  $i=1;
                              $musermst_query = "SELECT * FROM images where ref_id='$ref_id'"; 
                              ...
                              while ($row = mysql_fetch_array($run)) 
							  {
									...
									<tr>
										<td>'.$i.'</td>
										<td><img src="../'.$row['path'].'" height="150" width="200"></td>
										<td><a href="javascript:void(0);" id="'.$id.'_'.$ref_id.'" onclick="delete_image(this.id)">
