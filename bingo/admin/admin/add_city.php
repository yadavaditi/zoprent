<?php
   if(!isset($_SESSION)){ session_start();} 
    ...
    if (isset($_POST['submit_now'])) 
    {
		...
		$q=mysql_query("INSERT INTO city(city_name,image,priority,ref_id) 
							VALUES ('$city_name','$img','$priority','$ref_id')");
               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Add City</span></h4>
                     </div>
							  ...
							  <div class="form-group">
                                 ...
                                 <div class="col-lg-6">
                                    <?php
										...
										{
											echo '<input type="checkbox" name="service[]" value="'.$res['id'].'">&nbsp;&nbsp;'.$res['categories'];
											echo "&nbsp;&nbsp;";
										}
									?>
                                 </div>
