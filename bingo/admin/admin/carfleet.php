...
?>
<?php
$sql=mysql_query("SELECT a.carname, a.price_wkd,a.price_wknd,a.deposit,a.dlimit,b.name,b.address,b.contact from carfleet a,vendors b where a.vid = b.vid and b.city='bengaluru';");
                     ...
                     <div class="panel-body" >
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                           <fieldset class="content-group">
							  ...
							  <div class="col-md-2">
								<input type="text" class="form-control" name="search_filter" id="search" onkeyup="search_car();"  placeholder="Type of Filter"  > 
							  </div> 
							  <label><b>18% GST on all car booking</b></label>
