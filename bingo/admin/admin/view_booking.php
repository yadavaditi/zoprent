...
$query="select * from booking_details where status='Success' order by booked_date DESC";
...
<html lang="en">
   ...
   {
	 r=confirm("Are you Sure Want to Reject......?");
         			if(r==true)
         			{
						jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=reject_booking",
								datatype:"text",
								data:{id:id},
   ...
   function finish_booking(id)
   
   {
	 r=confirm("Are you Sure to This Booking is Finished......?");
         			if(r==true)
         			{
						jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=finish_booking",
								datatype:"text",
								data:{id:id},
								success:function(response)
								{
      ...
      <div class="page-header">
         <div class="page-header-content">
            <div class="page-title">
               <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Pending Orders</span> </h4>
            </div>
            <?php 
		 ...
		 <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
		  ...
		  <table class="table">
							  ...
							  <?php
								...
								$sql="select * from booking_details where status='success' order by booked_date ASC limit $pageLimit,".PAGE_PER_NO;
								...
								while($row=mysql_fetch_array($result))
								{
									...
									//$new_from_time=date("h:i:s a",strtotime($time));
