...
<html lang="en">
   ...
   <head>
	...
	function category_priority_update(this_id)
		 ...
		 function delete_vendor(this_id)
		{
               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vendor</span>- Details</h4>
                     </div>
                     <div class="heading-elements">
                        <ul class="icons-list">
                           <li><a href="add_vendor.php"><i class="fa fa-plus-square" style="font-size: 18px;"></i></a></li>
                     ...
                     <div class="panel-body" >
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                           <fieldset class="content-group">
							  ...
							  <div class="col-md-2">
								<input type="text" class="form-control" name="search_filter" id="search" onkeyup="search_vendor();"  placeholder="Type of Filter"  > 
							  </div> 
                           </fieldset>
                        </form>
                     </div>
                     ...
                     <table class="table">
                        ...
                        <tbody id="get_table">
                           <?php
                              ...
                              $musermst_query = "SELECT * FROM vendor  limit $pageLimit,".PAGE_PER_NO; 
