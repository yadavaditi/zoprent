...
$query="select * from sub_category order by priority DESC";
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.4.0/css/font-awesome.min.css">
   ...
   {
	 r=confirm("Are you Sure Want to Delete the Sub Category......?");
         			if(r==true)
         			{
						jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=delete_subcategory",
								datatype:"text",
								data:{id:id},
   ...
   function filter_main_details()
   {
	   data=$('#search').val();
	   
	   jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=filter_sub_category",
								datatype:"text",
								data:{data:data},
								success:function(response)
								{
   ...
   function category_priority_update(id)
   {
	   result=id.split("_");
	   res_id=result[1];
	   pri=$("#"+id).val();
	   ...
	   jQuery.ajax({
								type:"POST",
								url:"ajax.php?f=sub_category_priority_update",
								datatype:"text",
   ...
   function search_batch()
	  {
		  var data=$('#batch').val();
				...
				jQuery.ajax({
						type:"POST",
						url:"ajax.php?f=filter_category",
						datatype:"text",
						data:{data:data},
						success:function(response)
						{
               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sub Category</span></h4>
                     </div>
                    <div class="heading-elements">
						<ul class="icons-list">
                           <li><a href="add_sub_category.php"><i class="fa fa-plus-square"></i></a></li>
                        </ul>
			   ...
			   <div class="panel panel-flat">
				  ...
				  <div class="form-group">
							 <label class="control-label col-lg-1" style="padding-top:1%">Filter</label>
							  <div class="col-md-2">
								<input type="text" class="form-control" name="search_filter" id="search" onkeyup="filter_main_details();"  placeholder="Type of Filter"  > 
							  </div>
<div class="col-lg-2">
                                    <select class="form-control" name="fillter_batch" id="batch" onchange="search_batch();">
                     ...
                     <div class="panel-body">
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                           <fieldset class="content-group">
                              <legend class="text-bold">Sub-Category Details</legend>
							  <table class="table">
							  <tr>
							  <th>S.No</th>
							  <th>Main Category</th>
                          ...
                          <?php
								...
								$sql="select * from sub_category order by priority desc limit $pageLimit,".PAGE_PER_NO;
