...
if(!isset($_SESSION['from_date']) or !isset($_SESSION['to_date']))
{
    ...
    if(isset($_POST['rent_now'])){ //check if form was submitted
                    ...
                    <form action="" method="POST">
                        <fieldset id="account" style="margin-left:0px;">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-12">
                                    <div class="form-group input-group">
                                        <input type="submit" class="btn btn-primary" id="setDates" name="setDates" value="GO!!">
                                    </div>
                                </div>
                        ...
                        <fieldset id="area" style="margin-left:0px;">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-12">
                                    <div class="form-group input-group">
                                        <input type="submit" class="btn btn-primary" id="getBikes" name="getBikes" value="Get Bikes!!">
                                    </div>
                                </div>
                            ...
                            <div class="row" style="padding-top: 0%;">
                                <div class="row" style="padding-top:4%;">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 text-center">
                                        <img src="admin/assets/web_images/41royal-enfield-classic-350_black_gd.png" alt="image" height="119" width="189"><h4 style="font-family: ab2;"> Royal Enfield Classic 350</h4><span style="margin-left:-20px">Mon-Thu</span><span style="margin-left:30px">Fri-Sun</span> <h4 style="margin-top: 10px;font-family: ab2;font-weight:bold;"><i class="fa fa-inr" aria-hidden="true"></i>990/Day &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-inr" aria-hidden="true"> </i> 1160/Day</h4><p style="color:#004066;"><b>Onwards</b></p>
                                        <div class="query-submit-button top30">

                                            <a href="bookings.php?sub=Royal Enfield Classic 350&uid=1&city=Bengaluru">
